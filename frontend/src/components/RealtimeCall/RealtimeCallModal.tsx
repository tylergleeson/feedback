  ...
  return (
    <div className="fixed inset-0 z-50 bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        {isConnected && (
          <div className="mb-8">
            <div className="relative">
              ...
              <div className="absolute inset-0 w-24 h-24 rounded-full bg-green-500 animate-ping opacity-20"></div>
            </div>
          </div>
        )}
        ...
        {isConnecting && (
          <div className="mb-8">
            <div className="w-24 h-24 rounded-full border-4 border-gray-600 border-t-green-500 animate-spin"></div>
          </div>
        )}
